...
import Pat from '../assets/GroupWine.png'
    ...
    return (
        ...
        >
          ...
          >
            ...
            <nav className={`flex flex-col gap-10 md:flex-row lg:items-center md:fixed fixed lg:relative top-0 bg-[#5B0017] pt-40 lg:pt-0 pl-5 lg:pl-0 z-50 h-full md:top-0 left-0 w-[200px] md:w-auto  md:bg-transparent transition-transform ${
            ...
            <div className="flex ">
            <button className="bg-[#5B0017] text-white px-4 py-2 rounded-lg hover:bg-[#70011d] ">
              Book Now
            </button>
