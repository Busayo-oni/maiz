  ...
  const [isOpen, setIsOpen] = useState(false);
    return (
          <header className="bg-transparent text-white flex justify-between items-center px-8 py-4">
            ...
            <nav className={`flex flex-col gap-10 md:flex-row lg:items-center md:items-center  fixed lg:relative md:relative top-0 bg-[#CC9D2F] pt-40 md:pt-0 lg:pt-0 pl-5 lg:pl-0 md:pl-0 z-50 h-full md:top-0 left-0 w-[30%] md:w-auto  md:bg-transparent transition-transform ${
