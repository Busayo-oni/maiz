    ...
    return (
        ...
        >
          ...
          >
            ...
            <nav className={`flex flex-col gap-10 md:flex-row lg:items-center md:fixed fixed lg:relative top-0 bg-[#CC9D2F] pt-40 lg:pt-0 pl-5 lg:pl-0 z-50 h-full md:top-0 left-0 w-[40%] md:w-auto  md:bg-transparent transition-transform ${
